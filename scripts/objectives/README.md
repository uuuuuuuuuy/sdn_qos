...
4. **实验采集**：在 Objective 4 阶段使用 `objective4_collect_stats.py` 与 `objective4_plot.py` 快速生成 QoS 对比数据；如需跨阶段或定制化采样，可改用 `../tools/export_metrics.py`、`../tools/plot_metrics.py`。
